...
- Name: student-join-consultation.spec.js >> Student joins a consultation >> join button is no longer shown after the student has already joined
- Location: tests\e2e\student-join-consultation.spec.js:60:3
